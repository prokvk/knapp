(function() {
  var _, async, authErrorCode, getBaseApiUrl, getTestRoutes, invalidSchemaCode, ns, req, routeHasRequiredField, successfulTests, testRoute, testSchemaIntegrity, testsCount, validateInput;
  ...
  getBaseApiUrl = function() {
    ...
    return "" + conf.swagger.host + process.knapp_params.api_base_url;
  };
